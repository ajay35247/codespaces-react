  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-16 sm:px-10">
      <div className="rounded-[2rem] border border-white/10 bg-slate-950/90 p-10 shadow-2xl shadow-slate-900/20">
        ...
        <p className="mt-3 text-slate-300">Sign in with your email and password to access the logistics control tower.</p>
        ...
        <div className="mt-8 rounded-3xl bg-slate-900/80 p-6 text-sm text-slate-300">
          <p className="font-semibold text-slate-200">Demo credentials (optional):</p>
          <p className="mt-2">Email: demo@aptrucking.in</p>
